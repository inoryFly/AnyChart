...
//  * @private
//  */
// anychart.resourceModule.Calendar.AStorage.prototype.appliesByWeekDAY = function(date) {
...
//  * @private
//  */
// anychart.resourceModule.Calendar.AStorage.prototype.appliesByDAY = function(date) {
...
//  * @private
//  */
// anychart.resourceModule.Calendar.AStorage.prototype.replaceDAY = function(result, date) {
//   result.length = 0;
//   if (!this.holidays)
//     result.push([date.getTime(), date.getTime() + anychart.resourceModule.Calendar.MS_IN_DAY - anychart.resourceModule.Calendar.MS_IN_MINUTE_]);
//   return result;
// };
//
//
